...
async def download_coroutine(bot, session, custom_file_name, url, file_name, chat_id, message_id, start):
        ...
        with open(file_name, "wb") as f_handle:
            while True:
                ...
                if round(diff % 5.00) == 0 or downloaded == total_length:
                    ...
                    xLDx = (
    "**✨🚀 ʀᴜɴɴɪɴɢ ᴘʀᴇᴍɪᴜᴍ ʟᴀᴢʏ ᴄᴏɴꜱᴛʀᴜᴄᴛɪᴏɴ 🚀✨**\n"
    "**💎 ᴇɴᴊᴏʏ ᴜʟᴛʀᴀ-ꜰᴀꜱᴛ ᴅᴏᴡɴʟᴏᴀᴅ ꜱᴘᴇᴇᴅ 💨**\n"
    "**👑 ᴘᴏᴡᴇʀᴇᴅ ʙʏ [@PROVIDERBOTZ] (https://telegram.me/ProviderBotz) 👑**\n\n"
    "╔══════════════════╗\n"
    "📂 **𝐎𝐑𝐈𝐆𝐈𝐍𝐀𝐋 𝐅𝐈𝐋𝐄**\n"
    "╚══════════════════╝\n"
    ...
    "━━━━━━━━━━━━━━━━━━━\n"
    "⚡ **ᴘʀᴏɢʀᴇꜱꜱ:** `{tp}%`\n"
    "🧬 **ꜰɪʟᴇ ꜱɪᴢᴇ:** `{xxLAZY_BAPUXX_total_size}`\n"
    "━━━━━━━━━━━━━━━━━━━"
                  )
                    progress = "{0}{1}".format(
